...
module.exports = {
  ...
  async run(client, message, args) {
    ...
    const { data } = await get(`https://kitsu.io/api/edge/anime?filter[text]=${encodeURI(title.replace("--search", ""))}`, { method: "GET", headers: { 'Content-Type': "application/vnd.api+json", 'Accept': "application/vnd.api+json" } });
